                ...
                <section id="main-carousel" class="splide" aria-label="Beautiful Images">
                    <div class="splide__track">
                        <ul class="splide__list">
                            <li class="splide__slide">
                                <img
                                    src="https://mtsn3purbalingga.sch.id/wp-content/uploads/2021/03/IMG_20190409_093455-scaled.jpg"
                                    alt="">
                            </li>
                            <li class="splide__slide">
                                <img
                                    src="https://www.smkwalisongo2gempol.sch.id/laravel-filemanager/photos/shares/FASILITAS/ruang%20kelas.jpeg"
                                    alt="">
                            </li>
                            <li class="splide__slide">
                                <img
                                    src="https://pict.sindonews.net/dyn/620/pena/news/2020/06/08/711/62062/tahun-ajaran-baru-disdik-siap-tambah-ruang-kelas-baru-di-10-smp-makassar-ypv.jpg"
                                    alt="">
                            </li>
                        </ul>
                    </div>
