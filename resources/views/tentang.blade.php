        ...
        <section class="relative">
            ...
            <div class="container relative mx-auto z-10">
                <div class="flex gap-4">
                    <p class="inline-block p-3 text-2xl text-white bg-primary white-shadow font-bold">Sejarah Berdiri</p>
                ...
                <div class="bg-white min-h-20" style="margin-top: -2rem; margin-left: 2rem">
                    <p class="p-10"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="bg-primary min-h-20" style="margin-top: -2rem; margin-left: 2rem">
                            <p class="p-10 text-white"> Lorem Ipsum is simply dummy text of the printing and typesetting
                                industry.
                                Lorem
                                Ipsum has been the industry's standard dummy text ever since the 1500s, when an
                                unknown printer took a galley of type and scrambled it to make a type specimen
                    ...
                    <div>
                        <div class="flex gap-4">
                            <p class="inline-block p-3 text-2xl text-white bg-secondary white-shadow font-bold px-6">Misi
                            </p>
                            <div class="h-3 w-3 bg-white mt-2"></div>
                            <div class="h-3 w-3 bg-white mt-2"></div>
                            <div class="h-3 w-3 bg-white mt-2"></div>
            ...
            <div class="container relative mx-auto pt-40 z-10">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 mt-16" class="z-10">
                    <div>
                        ...
                        <div class="bg-white  p-3 pl-28" style="margin-top: -9rem; min-height: 8rem; margin-left: 2rem;">
            ...
            <div class="container mx-auto mt-10">
                <section id="main-carousel" class="splide" aria-label="Beautiful Images">
                    <div class="splide__track">
                        <ul class="splide__list">
                            <li class="splide__slide">
                                <img src="https://mtsn3purbalingga.sch.id/wp-content/uploads/2021/03/IMG_20190409_093455-scaled.jpg"
                                    alt="">
                            </li>
                            <li class="splide__slide">
                                <img src="https://www.smkwalisongo2gempol.sch.id/laravel-filemanager/photos/shares/FASILITAS/ruang%20kelas.jpeg"
                                    alt="">
                            </li>
                            <li class="splide__slide">
                                <img src="https://pict.sindonews.net/dyn/620/pena/news/2020/06/08/711/62062/tahun-ajaran-baru-disdik-siap-tambah-ruang-kelas-baru-di-10-smp-makassar-ypv.jpg"
                                    alt="">
                            </li>
                        </ul>
                    </div>
