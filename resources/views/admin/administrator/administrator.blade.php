        ...
        <div class="bg-white border rounded-md  p-5 my-3">
            ...
            <div class=" p-5 mt-3">
                <div class="flex gap-5">
                    <p class="flex-grow">Adminstrator</p>
                    <button id="addData"
...
@section('morejs')
    ...
    <script>
        ...
        $(document).on('click','.deleteData', function () {
            ...
            let id = $(this).data('id');
            confirmDeleteSerialize('Delete Data', 'apa anda yakin ?', token, '/admin/administrator/'+id+'/delete', afterSave)
            return false;
        })

        function saveForm() {
            confirmSave('Simpan Data Berita', 'Apa anda yakin ?', 'form', '{{route('administrator')}}', afterSave);
            return false
        }

        function afterSave() {
            modal.hide();
            $('#table').DataTable().ajax.url('/admin/administrator/datatable').load()
        }
        ...
        function showDatatable() {
            ...
            datatable('table', '/admin/administrator/datatable', colums)
